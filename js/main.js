    ...
    PredictionTimer = setTimeout(function(){
        ...
        switch (ran.toFixed(1)){
            ...
            case 0.2:
                    ...
                    break;
            case 0.3:
                    TimeoutTypeoutHandler(Main "СМЕРТЬ В НИЩИТЕ", 500)
                    break;
            default:
                    TimeoutTypeoutHandler(Main,"ТОРА",1000)
                    TimeoutTypeoutHandler(Info,"ТОРА это электрики лол",25)             
                    break;
        }
    },2000)
    shot = false
